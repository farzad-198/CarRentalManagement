...
namespace CarRentalManagement {
    ...
    public partial class CarDBDataSet1 : global::System.Data.DataSet {
        ...
        public partial class CarsDataTable : global::System.Data.TypedTableBase<CarsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "18.0.0.0")]
            public CarsRow AddCarsRow(int CarID, string CarName, string Model, string PlateNumber, string Color, int DailyRate, string Status) {
        ...
        public partial class CarsRow : global::System.Data.DataRow {
            ...
            public string PlateNumber {
                get {
                    try {
                        ...
                        throw new global::System.Data.StrongTypingException("The value for column \'PlateNumber\' in table \'Cars\' is DBNull.", e);
                    }
                }
                set {
            ...
            public int DailyRate {
                get {
                    try {
                        return ((int)(this[this.tableCars.DailyRateColumn]));
                    }
                    catch (global::System.InvalidCastException e) {
            ...
            public bool IsPlateNumberNull() {
                return this.IsNull(this.tableCars.PlateNumberColumn);
            }
            
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "18.0.0.0")]
            public void SetPlateNumberNull() {
                this[this.tableCars.PlateNumberColumn] = global::System.Convert.DBNull;
            }
...
namespace CarRentalManagement.CarDBDataSet1TableAdapters {
    ...
    public partial class CarsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Cars] WHERE (([CarID] = @Original_CarID) AND ((@IsNull_CarName = 1 AND [CarName] IS NULL) OR ([CarName] = @Original_CarName)) AND ((@IsNull_Model = 1 AND [Model] IS NULL) OR ([Model] = @Original_Model)) AND ((@IsNull_PlateNumber = 1 AND [PlateNumber] IS NULL) OR ([PlateNumber] = @Original_PlateNumber)) AND ((@IsNull_Color = 1 AND [Color] IS NULL) OR ([Color] = @Original_Color)) AND ((@IsNull_DailyRate = 1 AND [DailyRate] IS NULL) OR ([DailyRate] = @Original_DailyRate)) AND ((@IsNull_Status = 1 AND [Status] IS NULL) OR ([Status] = @Original_Status)))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Cars] ([CarID], [CarName], [Model], [PlateNumber], [Color], [DailyRate], [Status]) VALUES (@CarID, @CarName, @Model, @PlateNumber, @Color, @DailyRate, @Status);
SELECT CarID, CarName, Model, PlateNumber, Color, DailyRate, Status FROM Cars WHERE (CarID = @CarID)";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Cars] SET [CarID] = @CarID, [CarName] = @CarName, [Model] = @Model, [PlateNumber] = @PlateNumber, [Color] = @Color, [DailyRate] = @DailyRate, [Status] = @Status WHERE (([CarID] = @Original_CarID) AND ((@IsNull_CarName = 1 AND [CarName] IS NULL) OR ([CarName] = @Original_CarName)) AND ((@IsNull_Model = 1 AND [Model] IS NULL) OR ([Model] = @Original_Model)) AND ((@IsNull_PlateNumber = 1 AND [PlateNumber] IS NULL) OR ([PlateNumber] = @Original_PlateNumber)) AND ((@IsNull_Color = 1 AND [Color] IS NULL) OR ([Color] = @Original_Color)) AND ((@IsNull_DailyRate = 1 AND [DailyRate] IS NULL) OR ([DailyRate] = @Original_DailyRate)) AND ((@IsNull_Status = 1 AND [Status] IS NULL) OR ([Status] = @Original_Status)));
SELECT CarID, CarName, Model, PlateNumber, Color, DailyRate, Status FROM Cars WHERE (CarID = @CarID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT CarID, CarName, Model, PlateNumber, Color, DailyRate, Status FROM dbo.Cars" +
                "";
        ...
        public virtual int Delete(int Original_CarID, string Original_CarName, string Original_Model, string Original_PlateNumber, string Original_Color, global::System.Nullable<int> Original_DailyRate, string Original_Status) {
            ...
            if ((Original_DailyRate.HasValue == true)) {
                ...
                this.Adapter.DeleteCommand.Parameters[10].Value = ((int)(Original_DailyRate.Value));
            }
            else {
        ...
        public virtual int Insert(int CarID, string CarName, string Model, string PlateNumber, string Color, global::System.Nullable<int> DailyRate, string Status) {
            ...
            if ((DailyRate.HasValue == true)) {
                this.Adapter.InsertCommand.Parameters[5].Value = ((int)(DailyRate.Value));
            }
            else {
        ...
        public virtual int Update(int CarID, string CarName, string Model, string PlateNumber, string Color, global::System.Nullable<int> DailyRate, string Status, int Original_CarID, string Original_CarName, string Original_Model, string Original_PlateNumber, string Original_Color, global::System.Nullable<int> Original_DailyRate, string Original_Status) {
            ...
            if ((DailyRate.HasValue == true)) {
                this.Adapter.UpdateCommand.Parameters[5].Value = ((int)(DailyRate.Value));
            }
            else {
            ...
            if ((Original_PlateNumber == null)) {
                ...
                this.Adapter.UpdateCommand.Parameters[13].Value = ((string)(Original_PlateNumber));
            }
            if ((Original_Color == null)) {
            ...
            if ((Original_DailyRate.HasValue == true)) {
                ...
                this.Adapter.UpdateCommand.Parameters[17].Value = ((int)(Original_DailyRate.Value));
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string CarName, string Model, string PlateNumber, string Color, global::System.Nullable<int> DailyRate, string Status, int Original_CarID, string Original_CarName, string Original_Model, string Original_PlateNumber, string Original_Color, global::System.Nullable<int> Original_DailyRate, string Original_Status) {
            return this.Update(Original_CarID, CarName, Model, PlateNumber, Color, DailyRate, Status, Original_CarID, Original_CarName, Original_Model, Original_PlateNumber, Original_Color, Original_DailyRate, Original_Status);
        }
    }
