...
namespace CarRentalManagement {
    ...
    public partial class CarRentalDBDataSet : global::System.Data.DataSet {
        ...
        public partial class CustomersDataTable : global::System.Data.TypedTableBase<CustomersRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "18.0.0.0")]
            public CustomersRow AddCustomersRow(string CustomerName, string Email, string Phone, string Address) {
...
namespace CarRentalManagement.CarRentalDBDataSetTableAdapters {
    ...
    public partial class CustomersTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Customers] WHERE (([CustomerID] = @Original_CustomerID) AND ([CustomerName] = @Original_CustomerName) AND ((@IsNull_Email = 1 AND [Email] IS NULL) OR ([Email] = @Original_Email)) AND ((@IsNull_Phone = 1 AND [Phone] IS NULL) OR ([Phone] = @Original_Phone)) AND ((@IsNull_Address = 1 AND [Address] IS NULL) OR ([Address] = @Original_Address)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO [dbo].[Customers] ([CustomerName], [Email], [Phone], [Address]) VALUE" +
                "S (@CustomerName, @Email, @Phone, @Address);\r\nSELECT CustomerID, CustomerName, E" +
                "mail, Phone, Address FROM Customers WHERE (CustomerID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Customers] SET [CustomerName] = @CustomerName, [Email] = @Email, [Phone] = @Phone, [Address] = @Address WHERE (([CustomerID] = @Original_CustomerID) AND ([CustomerName] = @Original_CustomerName) AND ((@IsNull_Email = 1 AND [Email] IS NULL) OR ([Email] = @Original_Email)) AND ((@IsNull_Phone = 1 AND [Phone] IS NULL) OR ([Phone] = @Original_Phone)) AND ((@IsNull_Address = 1 AND [Address] IS NULL) OR ([Address] = @Original_Address)));
SELECT CustomerID, CustomerName, Email, Phone, Address FROM Customers WHERE (CustomerID = @CustomerID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT CustomerID, CustomerName, Email, Phone, Address FROM dbo.Customers";
        ...
        public virtual int Fill(CarRentalDBDataSet.CustomersDataTable dataTable) {
        ...
        public virtual CarRentalDBDataSet.CustomersDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            CarRentalDBDataSet.CustomersDataTable dataTable = new CarRentalDBDataSet.CustomersDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "18.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(CarRentalDBDataSet.CustomersDataTable dataTable) {
        ...
        public virtual int Delete(int Original_CustomerID, string Original_CustomerName, string Original_Email, string Original_Phone, string Original_Address) {
        ...
        public virtual int Insert(string CustomerName, string Email, string Phone, string Address) {
        ...
        public virtual int Update(string CustomerName, string Email, string Phone, string Address, int Original_CustomerID, string Original_CustomerName, string Original_Email, string Original_Phone, string Original_Address, int CustomerID) {
            if ((CustomerName == null)) {
                throw new global::System.ArgumentNullException("CustomerName");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string CustomerName, string Email, string Phone, string Address, int Original_CustomerID, string Original_CustomerName, string Original_Email, string Original_Phone, string Original_Address) {
            return this.Update(CustomerName, Email, Phone, Address, Original_CustomerID, Original_CustomerName, Original_Email, Original_Phone, Original_Address, Original_CustomerID);
        }
    }
