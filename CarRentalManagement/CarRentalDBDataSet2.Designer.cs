...
namespace CarRentalManagement {
    ...
    public partial class CarRentalDBDataSet2 : global::System.Data.DataSet {
        ...
        public partial class PaymentsDataTable : global::System.Data.TypedTableBase<PaymentsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "18.0.0.0")]
            public PaymentsRow AddPaymentsRow(int RentalID, decimal Amount, string PaymentMethod, System.DateTime PaymentDate) {
...
namespace CarRentalManagement.CarRentalDBDataSet2TableAdapters {
    ...
    public partial class PaymentsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM [dbo].[Payments] WHERE (([PaymentID] = @Original_PaymentID) AND ([Ren" +
                "talID] = @Original_RentalID) AND ([Amount] = @Original_Amount) AND ([PaymentMeth" +
                "od] = @Original_PaymentMethod) AND ([PaymentDate] = @Original_PaymentDate))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Payments] ([RentalID], [Amount], [PaymentMethod], [PaymentDate]) VALUES (@RentalID, @Amount, @PaymentMethod, @PaymentDate);
SELECT PaymentID, RentalID, Amount, PaymentMethod, PaymentDate FROM Payments WHERE (PaymentID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Payments] SET [RentalID] = @RentalID, [Amount] = @Amount, [PaymentMethod] = @PaymentMethod, [PaymentDate] = @PaymentDate WHERE (([PaymentID] = @Original_PaymentID) AND ([RentalID] = @Original_RentalID) AND ([Amount] = @Original_Amount) AND ([PaymentMethod] = @Original_PaymentMethod) AND ([PaymentDate] = @Original_PaymentDate));
SELECT PaymentID, RentalID, Amount, PaymentMethod, PaymentDate FROM Payments WHERE (PaymentID = @PaymentID)";
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT PaymentID, RentalID, Amount, PaymentMethod, PaymentDate FROM dbo.Payments";
        ...
        public virtual int Fill(CarRentalDBDataSet2.PaymentsDataTable dataTable) {
        ...
        public virtual CarRentalDBDataSet2.PaymentsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            CarRentalDBDataSet2.PaymentsDataTable dataTable = new CarRentalDBDataSet2.PaymentsDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "18.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(CarRentalDBDataSet2.PaymentsDataTable dataTable) {
        ...
        public virtual int Delete(int Original_PaymentID, int Original_RentalID, decimal Original_Amount, string Original_PaymentMethod, System.DateTime Original_PaymentDate) {
        ...
        public virtual int Insert(int RentalID, decimal Amount, string PaymentMethod, System.DateTime PaymentDate) {
        ...
        public virtual int Update(int RentalID, decimal Amount, string PaymentMethod, System.DateTime PaymentDate, int Original_PaymentID, int Original_RentalID, decimal Original_Amount, string Original_PaymentMethod, System.DateTime Original_PaymentDate, int PaymentID) {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(int RentalID, decimal Amount, string PaymentMethod, System.DateTime PaymentDate, int Original_PaymentID, int Original_RentalID, decimal Original_Amount, string Original_PaymentMethod, System.DateTime Original_PaymentDate) {
            return this.Update(RentalID, Amount, PaymentMethod, PaymentDate, Original_PaymentID, Original_RentalID, Original_Amount, Original_PaymentMethod, Original_PaymentDate, Original_PaymentID);
        }
    }
