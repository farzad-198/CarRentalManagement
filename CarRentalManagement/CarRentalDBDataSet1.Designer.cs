...
namespace CarRentalManagement {
    ...
    public partial class CarRentalDBDataSet1 : global::System.Data.DataSet {
        ...
        public partial class CarsDataTable : global::System.Data.TypedTableBase<CarsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "18.0.0.0")]
            public CarsRow AddCarsRow(string CarName, string Model, string PlateNumber, string Color, decimal DailyRate, string Status) {
...
namespace CarRentalManagement.CarRentalDBDataSet1TableAdapters {
    ...
    public partial class CarsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = @"DELETE FROM [dbo].[Cars] WHERE (([CarID] = @Original_CarID) AND ([CarName] = @Original_CarName) AND ([Model] = @Original_Model) AND ([PlateNumber] = @Original_PlateNumber) AND ((@IsNull_Color = 1 AND [Color] IS NULL) OR ([Color] = @Original_Color)) AND ([DailyRate] = @Original_DailyRate) AND ([Status] = @Original_Status))";
            ...
            this._adapter.InsertCommand.CommandText = @"INSERT INTO [dbo].[Cars] ([CarName], [Model], [PlateNumber], [Color], [DailyRate], [Status]) VALUES (@CarName, @Model, @PlateNumber, @Color, @DailyRate, @Status);
SELECT CarID, CarName, Model, PlateNumber, Color, DailyRate, Status FROM Cars WHERE (CarID = SCOPE_IDENTITY())";
            ...
            this._adapter.UpdateCommand.CommandText = @"UPDATE [dbo].[Cars] SET [CarName] = @CarName, [Model] = @Model, [PlateNumber] = @PlateNumber, [Color] = @Color, [DailyRate] = @DailyRate, [Status] = @Status WHERE (([CarID] = @Original_CarID) AND ([CarName] = @Original_CarName) AND ([Model] = @Original_Model) AND ([PlateNumber] = @Original_PlateNumber) AND ((@IsNull_Color = 1 AND [Color] IS NULL) OR ([Color] = @Original_Color)) AND ([DailyRate] = @Original_DailyRate) AND ([Status] = @Original_Status));
SELECT CarID, CarName, Model, PlateNumber, Color, DailyRate, Status FROM Cars WHERE (CarID = @CarID)";
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = global::CarRentalManagement.Properties.Settings.Default.CarRentalDBConnectionString;
        }
        ...
        public virtual int Fill(CarRentalDBDataSet1.CarsDataTable dataTable) {
        ...
        public virtual CarRentalDBDataSet1.CarsDataTable GetData() {
            this.Adapter.SelectCommand = this.CommandCollection[0];
            CarRentalDBDataSet1.CarsDataTable dataTable = new CarRentalDBDataSet1.CarsDataTable();
        ...
        [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "18.0.0.0")]
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        public virtual int Update(CarRentalDBDataSet1.CarsDataTable dataTable) {
        ...
        public virtual int Delete(int Original_CarID, string Original_CarName, string Original_Model, string Original_PlateNumber, string Original_Color, decimal Original_DailyRate, string Original_Status) {
            ...
            if ((Original_PlateNumber == null)) {
                ...
                this.Adapter.DeleteCommand.Parameters[3].Value = ((string)(Original_PlateNumber));
            }
        ...
        public virtual int Insert(string CarName, string Model, string PlateNumber, string Color, decimal DailyRate, string Status) {
            if ((CarName == null)) {
        ...
        public virtual int Update(string CarName, string Model, string PlateNumber, string Color, decimal DailyRate, string Status, int Original_CarID, string Original_CarName, string Original_Model, string Original_PlateNumber, string Original_Color, decimal Original_DailyRate, string Original_Status, int CarID) {
            if ((CarName == null)) {
                throw new global::System.ArgumentNullException("CarName");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string CarName, string Model, string PlateNumber, string Color, decimal DailyRate, string Status, int Original_CarID, string Original_CarName, string Original_Model, string Original_PlateNumber, string Original_Color, decimal Original_DailyRate, string Original_Status) {
            return this.Update(CarName, Model, PlateNumber, Color, DailyRate, Status, Original_CarID, Original_CarName, Original_Model, Original_PlateNumber, Original_Color, Original_DailyRate, Original_Status, Original_CarID);
        }
    }
